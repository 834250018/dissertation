...
public class FileUploadController {
    ...
    public String uploadTempFile(MultipartFile multipartFile) {
        try {
            ...
            throw new VeBaseException("100001");
        }
    }
     ...
     * @return
     */
    @PostMapping("/admin/v1/getPreSignFile")
     ...
     * @param response
     */
    @PostMapping("/admin/v1_0/getFileWithTag/{date}/{fileName}")
     ...
     * @param response
     */
    @PostMapping("/admin/v1_0/getPrivateFile/{date}/{fileName}")
