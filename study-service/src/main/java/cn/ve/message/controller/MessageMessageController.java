...
import cn.ve.study.dto.MessageMessageDTO;
...
@Validated
@RestController
@RequestMapping("/studyMessage")
public class MessageMessageController extends BaseController {

    @Resource
    private MessageMessageMapper studyMessageMapper;
...
//            .copyList(studyMessageMapper.selectList(new LambdaQueryWrapper<>()), MessageMessageDTO.class));
//    }
...
//
//        // todo 已读此模板类型所有消息
//        //        studySystemAlertExtMapper.readByTemplateType(qo);
//
//        return of;
//    }
    ...
    public void confirm(@RequestParam Long studyId) {
        // todo
        //        studySystemAlertExtMapper.readById(studyId);
    }
    ...
    public void confirmByQO(@ModelAttribute @Valid MessageMessageQO qo) {
        qo.setUserId(getUserId());
        // todo
        //        studySystemAlertExtMapper.readByQO(qo);
    }
